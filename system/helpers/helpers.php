...
function findRoutByName($name)
{
    global $routes;
    $allRoutes = array_merge($routes['post'], $routes['get'], $routes['put'], $routes['delete']);
    $route = null;
...
function route($name, $params = [])
{
    ...
    $route = findRoutByName($name);
    if ($route === null) {
        throw new Exception("url name not found!!!");
    }
